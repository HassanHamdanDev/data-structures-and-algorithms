...
const toLastNames = people => {
  // Solution code here...
  let fullNames = people.map(elem => `${elem.firstName} ${elem.lastName}`);
  return fullNames;
};
...
const addPurchases = (arr) => {
  // Solution code here...
  let totalPrice = arr.reduce((accumulator, elem) => {
    accumulator += elem.purchasePrice;
    return accumulator;
  }, 0);
  return totalPrice;
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let elements = arr.reduce((accumulator) => {
    accumulator++;
    return accumulator;
  }, 0);
  return elements;
...
const returnNames = (arr) => {
  // Solution code here...
  let charactersNames = arr.reduce((accumulator, elem) => {
...
const reversedString = (str) => {
  // Solution code here...
  let stringChar = str.split('');
  let reversed = stringChar.reduce((accumulator, char) => {
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  let filtered = arr.filter(elem => elem.children);
  let result = filtered.reduce((acc, elem) => {
    acc += elem.children.length;
    return acc;
  }, 0);
  return result;
};
...
const extractChildren = (arr) => {
  // Solution code here...
  let filtered = arr.filter(elem => elem.children);
  let filtername = filtered.filter(elem => elem.name.includes('a'));
  let childerens = filtername.reduce((acc, elem) => {
