...
const raisedToTheThird = (arr) => {
  // Solution code here...
  let newArr = [];
  arr.forEach(elem => newArr.push(Math.pow(elem, 3)));
  return newArr;
};
...
const addQuestion = (arr) => {
  // Solution code here...
  let result = arr.map(elem => elem.concat('?'));
  return result;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let result = arr.map(elem => Math.pow(2, elem));
  return result;
};
...
const charCode = (arr) => {
  // Solution code here...
  let answer = arr.map(elem => elem.charCodeAt());
  return answer;
};
...
const extractAbilities = (arr) => {
  // Solution code here...
  let result = arr.map(elem => elem.ability.name);
  return result;
};
