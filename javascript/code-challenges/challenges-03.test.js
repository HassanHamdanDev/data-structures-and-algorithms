...
const typeNum = (arr) => {
  // Solution code here...
  let numbers = arr.filter(elem => typeof (elem) === 'number');
  return numbers;
};
...
const containsAnd = (arr) => {
  ...
  let andArr = arr.filter(elem => elem.includes('and'));
  return andArr;
};
...
const oddValues = (arr) => {
  // Solution code here...
  let oddNumbers = arr.filter(elem => elem % 2);
  return oddNumbers;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let notInArr = arr.filter(elem => !(forbiddenValues.includes(elem)));
  return notInArr;
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  let result = arr.filter(elem => elem.baseStat > minBaseStat);
  return result;
};
...
const getStatName = (arr, minBaseStat) => {
  // Solution code here...
  let result = arr.filter(elem => elem.baseStat > minBaseStat);
  let answer = result.map(elem => elem.stat.name);
  return answer;
};
...
const getCharactersWithoutChildren = (arr) => {
  // Solution code here...
  let result = arr.filter(elem => !(elem.children));
  // let answer = result.map(elem => elem.name);
  return result;
};
...
const evenOddNumericValues = (arr) => {
  // Solution code here...
  let numbersfilter = arr.filter(elem => typeof (elem) === 'number');
  let result = numbersfilter.map(elem => {
    if (elem % 2) {
      return 'odd';
    } else {
      return 'even';
